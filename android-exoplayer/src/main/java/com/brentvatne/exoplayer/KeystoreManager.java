...
public class KeystoreManager {
    ...
    KeyStore keyStore;
    KeyPair keyPair;
    static final String ALIAS = "AzamTV_Max_12345678"; //Enter your alias here (only a name for the key pair instance)
            ...
            if (!keyStore.containsAlias(ALIAS)) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    ...
                    KeyPairGeneratorSpec spec = new KeyPairGeneratorSpec.Builder(context)
                            .setAlias(ALIAS)
                            .setSubject(new X500Principal("CN=AzamTV, O=Azam"))
